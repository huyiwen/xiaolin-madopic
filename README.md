...
实时预览会显示当前页，在放大/缩小按钮旁使用“上一页 / 下一页”切换，页码显示当前位置和总页数。每页保持小红书的 3:4 比例，单页超出的内容仍会裁切，请在合适的位置手动分页。
...
点击“背景设置”旁的“页眉页脚”，可分别设置每页左上角、右上角、左下角和右下角的文字。四个位置独立支持字体、字号、颜色、加粗和斜体，也可输入多行文字；留空即可隐藏。
